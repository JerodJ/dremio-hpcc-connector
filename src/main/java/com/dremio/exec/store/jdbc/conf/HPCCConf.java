...
@SourceType(value = "HPCCARP", label = "HPCC",uiConfig = "hpcc-layout.json")
public class HPCCConf extends AbstractArpConf<HPCCConf> {
  private static final String ARP_FILENAME = "arp/implementation/hpcc-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.hpcc.HPCCDriver";
